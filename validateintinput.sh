...
# Running the Script
# This entire script is a function that can be copied into other shell scripts or included as a library file. 
# To turn this into a command, simply append the following to the bottom of the script:
